...
class GameTurnHandlerTests(unittest.TestCase):
    def test_creation(self: "GameTurnHandlerTests") -> None:
    ...
    def test_empty_creation(self: "GameTurnHandlerTests") -> None:
    ...
    def test_next_turn(self: "GameTurnHandlerTests") -> None:
    ...
    def test_copy(self: "GameTurnHandlerTests") -> None:
        game_turn_handler = GameTurnHandler.GameTurnHandler([4, 5, 6, 7, 9])
        game_turn_handler.next_turn()
